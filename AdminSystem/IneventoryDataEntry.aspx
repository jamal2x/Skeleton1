...
<body>
    <form id="form2" runat="server">
        <div>
            <asp:Label ID="lblPartID" runat="server" style="z-index: 1; left: 10px; top: 15px; position: absolute" Text="Part ID"></asp:Label>
        ...
        <asp:Label ID="lblPrice" runat="server" style="z-index: 1; left: 9px; top: 146px; position: absolute" Text="Price"></asp:Label>
        <p>
            <asp:Label ID="lblInStock" runat="server" style="z-index: 1; left: 10px; top: 187px; position: absolute" Text="In Stock "></asp:Label>
        ...
        <asp:Label ID="lblPaid" runat="server" style="z-index: 1; left: 13px; top: 231px; position: absolute; width: 43px" Text="Paid"></asp:Label>
        ...
        <p>
            <asp:Label ID="lblQuantity" runat="server" style="z-index: 1; left: 10px; top: 107px; position: absolute; height: 30px" Text="Quantity"></asp:Label>
        </p>
