...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="txtServiceID" runat="server" style="z-index: 1; left: 167px; top: 13px; position: absolute; bottom: 890px" width="188px" height="29px" BorderColor="White"></asp:TextBox>
        </div>
        ...
        <asp:Label ID="lblLabourCost" runat="server" style="z-index: 1; left: 9px; top: 96px; position: absolute; width: 143px" Text="Labour Cost"></asp:Label>
        <p>
            <asp:TextBox ID="txtVehicleID" runat="server" style="z-index: 1; left: 167px; top: 54px; position: absolute" width="188px"></asp:TextBox>
        </p>
        <p>
            <asp:Label ID="lblPartCost" runat="server" style="z-index: 1; left: 11px; top: 142px; position: absolute" Text="Part Cost" width="124px"></asp:Label>
            <asp:TextBox ID="txtLabourCost" runat="server" style="z-index: 1; left: 167px; top: 97px; position: absolute" width="188px" height="29px" TextMode="Number"></asp:TextBox>
        </p>
        <p>
            &nbsp;</p>
        <p>
        ...
        <asp:TextBox ID="txtPartCost" runat="server"  style="z-index: 1; left: 166px; top: 143px; position: absolute" width="188px" height="29px" TextMode="Number"></asp:TextBox>
        ...
        <asp:TextBox ID="txtInvoiceDate" runat="server" style="z-index: 1; left: 173px; top: 232px; position: absolute" width="188px" height="29px" TextMode="Date"></asp:TextBox>
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; top: 393px; position: absolute; left: 160px; width: 83px" Text="Cancel" OnClick="btnCancel_Click" />
        <p>
            <asp:Button ID="btnReturn" runat="server" OnClick="btnReturn_Click" style="z-index: 1; left: 395px; top: 394px; position: absolute; width: 218px" Text="Return to Main Menu" />
        </p>
    </form>
</body>
</html>
